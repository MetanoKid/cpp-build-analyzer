...
namespace
{
    const char* REPORT_MESSAGE =
        ...
        "Please mention the commit you're working on and attach these files:\n"
        "  Generated .dmp\n"
        "  CppBuildAnalyzer.exe\n"
        "  CppBuildAnalyzer.pdb\n"
        "\n"
        "The .dmp file is tied to the .exe that caused it and we need its .pdb\n"
        "in order to debug it. Unfortunately, we can't use a .exe and .pdb of\n"
        "our own, even if their commits match.\n"
        "\n"
        "Dumps from Debug configurations are preferred as they contain more info.\n"
        "\n"
        "============================= WARNING =============================\n"
